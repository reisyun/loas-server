...
describe('GetCollectionService', () => {
  ...
  describe('execute', () => {
    test('Expect it return collection', async () => {
      ...
      const getCollectionPort: GetCollectionPort = {
        executorId: mockCollection.getCollector.getId,
    ...
    test('When collection not found, expect it throws Exception', async () => {
      ...
      try {
        const getCollectionPort: GetCollectionPort = { executorId: v4(), collectionId: v4() };
